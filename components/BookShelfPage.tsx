                ...
                >
                    ...
                    <View style={styles.actions}>
                        <TouchableOpacity onPress={() => onToggleFavorite(book.id)}>
                            <Heart size={20} color={book.isFavorite ? '#00FFD4' : '#79747E'} fill={book.isFavorite ? '#00FFD4' : 'none'} />
                        </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    newBookButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#2F2E2E', borderRadius: 10, padding: 12, marginTop: 16 },
