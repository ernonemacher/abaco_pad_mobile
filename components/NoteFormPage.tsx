        ...
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                ...
                <TextInput
                    ...
                    multiline
                />
                <TouchableOpacity style={styles.editSettingsButton} onPress={onEditSettings}>
...
const styles = StyleSheet.create({
    ...
    pageTitle: { color: '#fff', fontSize: 24, marginBottom: 16, textAlign: 'center' },
    form: { width: '100%', gap: 16 },
    input: { width: '100%', height: 42, backgroundColor: '#fff', borderRadius: 10, paddingHorizontal: 16, fontSize: 18, color: '#000' },
    textArea: { width: '100%', height: 180, backgroundColor: '#fff', borderRadius: 10, paddingHorizontal: 16, textAlignVertical: 'top' },
    editSettingsButton: {
    ...
    button: { backgroundColor: '#008A73', paddingVertical: 12, borderRadius: 10, marginTop: 16, alignItems: 'center' },
